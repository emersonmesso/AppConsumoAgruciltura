...
<div class="container-fluid position-fixed p-2" id="menuBaixo">
    ...
    <div class="row">
        ...
        <div class="col-6 text-center">
            <button type="button" class="btn btn-link w-100 h-100 text-info" id="btnRelatorios" style="font-size: 35px;"><i class="fas fa-file-export"></i></button>
        </div>
    </div>
...
<div class="p-2 text-center text-white bg-danger rounded" id="telaErros">
    ...
    <script src="Backend/Script/circle.js"></script>
